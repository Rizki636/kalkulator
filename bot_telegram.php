...
$token = "2146702080:AAENzxW2_Bllpz40ZOtugIzzKs5LqoKiRDM";  // isi token bot di sini
$username_dev = "@Rizki636";
		...
		//proses input
			...
			switch($p2_teks[0]){
                ...
                case "/encode": case "/encode$username_bot" :
                  ...
                  $ot_teks =   $utf8;
                break;
                case "/hitung": case "/hitung$username_bot" : case "hitung" : case "=" :
                    //Operasi Penghitungan
                    if(!empty($p2_teks[1])){
                        $ot_teks = hitung(preg_replace("/\s/", '', $p2_teks[1]));
                    }
                    else if(substr($p2_teks[0],0,1) == "/"){
                        $ot_teks =  "Format penggunaan : \n".
                                    "/hitung 1 + 2\n".
                                    "/hitung 2 x 5 - 3\n".
                                    "hitung 5 / 5";
                    }
